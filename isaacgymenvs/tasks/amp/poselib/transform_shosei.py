...
# FBX에서 모션 데이터 로드
fbx_file_path = "data/shosei/shosei_corks.fbx"
npy_file_path = fbx_file_path.replace(".fbx", ".npy")
...
motion_translation[:, 1] = motion_translation[:, 1]  + 1 # Y값에 -0.95 적용
motion_translation[:, 2] = motion_translation[:, 2]  + 9.4 # Z값에 +0.97 적용
...
transformed_motion.to_file(npy_file_path)
